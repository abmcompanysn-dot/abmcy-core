...
// Système léger de notifications temporaires ("Produit ajouté avec
// succès", etc.), demandé explicitement par le client (HANI'S) qui
// signalait que les actions réussissaient silencieusement. Pas de
